...
sudo -u $user bash -c "cd /home/$user/c9sdk && rm scripts/install-sdk.sh && wget https://raw.githubusercontent.com/gvoze32/install/master/install-sdk.sh -O scripts/install-sdk.sh && scripts/install-sdk.sh"
